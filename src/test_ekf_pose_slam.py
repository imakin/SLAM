...
from slam_makin.srv import SetPositionRequest, SetPosition
import PyKDL
import numpy as np
...
class Navigator :
    ...
    def __init__(self, name):
        ...
        self.pub_landmark = rospy.Publisher("/pose_ekf_slam/landmark_update/landmark_0", 
                                            PoseWithCovarianceStamped)
        self.pub_landmark2 = rospy.Publisher("/pose_ekf_slam/landmark_update/landmark_1", 
                                            PoseWithCovarianceStamped)
        ...
        rospy.Timer(rospy.Duration(1.0), self.pubPose)
        rospy.Timer(rospy.Duration(1.0), self.pubLandmark)
    ...
    def pubPose(self, event):
        ...
        p.pose.covariance[0] = 0.1
        p.pose.covariance[7] = 0.1
        p.pose.covariance[14] = 0.1
        ...
        o = tf.transformations.quaternion_from_euler(0.0, 0.0, 0.0, 'sxyz')
        pose_tf.sendTransform((1.5, 2.5, 0.0), o, p.header.stamp, 
    ...
    def pubLandmark(self, event):
        ...
        p_t = PyKDL.Vector(-1.209, 3.771, 0.0)
        ...
        p.pose.covariance[0] = 0.0005
        p.pose.covariance[7] = 0.0005
        p.pose.covariance[14] = 0.0005
        ...
        p_t = PyKDL.Vector(1.345, 3.941, 0.0)
